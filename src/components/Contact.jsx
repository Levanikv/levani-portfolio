  ...
  return (
    <section id="contact" className="contact">
      <div className="wrap">
        ...
        <p className="contact-sub reveal-fade">Besoin de structurer, scaler ou d&eacute;bloquer votre design system ? Parlons-en.</p>
  ...
  return (
    <section id="contact" className="contact">
      <div className="wrap">
        ...
        <p className="contact-sub">Un chantier design system en vue ? Parlons-en.</p>
